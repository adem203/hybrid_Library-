...
const { isBibliothecaire, isAdmin, requireRole } = require('../../middleware/roles.middleware');
...
router.get('/reservations', authMiddleware, isBibliothecaire, statsController.getStatsReservations);

// Stats admin globales (utilisateurs, réservations, formats)
